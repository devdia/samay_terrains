        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h2 class="card-title">Vente de terrain</h2>
                    <form action="{{route('ventes.store')}}" method="POST" class="custom-validation">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input class="form-control" type="text" id="acquereur"
                                       name="acquereur" value="{{ old('acquereur') }}" autocomplete="off" required>
                                @error('acquereur')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input class="form-control" type="text" id="vendeur"
                                       name="vendeur" value="{{ old('vendeur') }}" autocomplete="off" required>
                                @error('vendeur')
                                <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input class="form-control" type="number" id="prix"
                                       name="prix" value="{{ old('prix') }}" autocomplete="off" required>
